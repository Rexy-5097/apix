...
2. Lower-level standards (Tiers 3 & 4) must reference the parent file's standard path (e.g. `[standards/security.md](file:///Users/soumyadebtripathy/WorkFlow/agentos-template/standards/security.md)`) for cross-cutting concerns.
