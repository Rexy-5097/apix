...
> Vendor-neutral instructions. `CLAUDE.md` is a synchronised copy of this file,
> kept so Claude Code discovers it automatically. Change both together.
>
> AgentOS's third law is vendor neutrality: core project guidance never depends
> on one assistant. Read `AGENTOS.md` for the framework initialization protocol.
